   ...
   <div id="wrapper">
      ...
      <section class="navbar">
         <ul class="navigation">
            ...
            <li class="navigationLink" v-on:click="$router.push({ name: 'Contact' })"><a class="active"> Contact</a></li>
      ...
      <section class="mainContent">
         <div style="display:flex; flex-direction:column; align-items:center">
            ...
            <div style="margin:auto; padding:.5vh">
               <label style="font-size:1.5vw">Do you need to get into contact with us?</label>
            </div>
            <div style="margin:auto; padding:.5vh">
               <textarea id="w3review" style="font-size:1.5vw; margin-left:2vw; text-align:center" name="w3review" rows="4" cols="50">Please leave us a message here </textarea>
            </div>
            <button style="font-size:1vw">Send</button>
         </div>
         <div style="margin:auto; padding:.5vh">
         </div>
      </section>
